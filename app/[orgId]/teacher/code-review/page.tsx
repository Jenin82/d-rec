...
export default function CodeReviewPage() {
  ...
  return (
    <AppShell
      title="Code Review"
      subtitle={`Review student code submissions along with their algorithms and output in ${orgName}`}
      navItems={navItems}
    >
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Pending Code</h2>
          <p className="text-sm text-muted-foreground">
            Students waiting for your final review on their code implementation
          </p>
        </div>
                    ...
                    <CardContent className="flex items-start gap-3 p-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          The code appears to follow the algorithm structure.
                          Consider checking edge cases for empty input and
                          verifying time complexity matches constraints.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
