...
export default function AlgorithmReviewPage() {
  ...
  useEffect(() => {
    ...
    loadOrgDetails();
  }, [fetchAlgorithmSubmissions, orgId]);
  ...
  return (
    <AppShell
      ...
      subtitle={`Review and provide feedback on student algorithm submissions in ${orgName}`}
      navItems={navItems}
    >
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Students waiting for your feedback on their algorithm designs
          </p>
        </div>
